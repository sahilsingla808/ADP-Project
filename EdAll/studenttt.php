...
<div class="box box6 shadow6">
    <h2><?
        $q="SELECT * FROM Students WHERE ROLLNO=".$_SESSION['uname']."";
        $x=$db->query($q);
...
<br><br>
<a href="sedit.php"><button type="button" class="btn btn-info"  data-target="#demo" style="width: 400px ">Edit Info</button></a>
<br><br><br><br>
...
foreach($rows as $row)
{
  ...
  echo "<br> <p> <button class=\"w3-btn w3-sand\" style=\"border-radius:50%\"> <a href=x.php?q=$cid>$cname</a> </button></p>";
