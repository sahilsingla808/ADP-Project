...
$cour=$db->query("SELECT * FROM SEM_COURSES WHERE TEACHER_ID= ".$_SESSION['unamefac']."");
...
foreach($rows as $row)
{
  ...
  echo "<br> <p> <button class=\"w3-btn w3-sand\"style=\" border-radius:50% ;\"> <a href=file.php?q=$cid>$cname</a> </button></p>";
