...
if( isset($_POST['uname'])&&isset($_POST['psw']) && isset($_POST['name'])&&isset($_POST['info']) && isset($_POST['security'])&&isset($_POST['address']) &&isset($_POST['cno']) )
{

    if(!empty($_POST['uname'])&& !empty($_POST['psw']) && !empty($_POST['name'])&& !empty($_POST['info']) && !empty($_POST['security'])&& !empty($_POST['address']) && !empty($_POST['cno']))
  {

    if($_POST['uname']==$_SESSION['unamefac'])
    {
    $q ="UPDATE PROF SET NAME='".$_POST['name']."' , PASSWORD= '".$_POST['psw']."', CONTACT=".$_POST['cno'].", INFO='".$_POST['info']."',  SECURITY_ANSWER='".$_POST['security']."', ADDRESS='".$_POST['address']."' WHERE TEACHER_ID=".$_POST['uname']." ";
...
foreach($rows as $row)
{
  ...
  <div class=\"container\">
    ...
    <label><b>ID</b></label>
    <br>
    <input type=\"text\" placeholder=\"Enter ID\" name=\"uname\" value=\"".$row['TEACHER_ID']."\" style=\"color: gray;\">
    <br>
    ...
    <br>
    <input type=\"password\" placeholder=\"Enter Security Answer\" name=\"security\"   value=\" ".$row['SECURITY_ANSWER']." \" style=\"color: gray;\" required>
    <br>
